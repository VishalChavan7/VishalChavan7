...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white&labelColor=0077B5)](https://linkedin.com/in/vishal--chavan)
[![Twitter](https://img.shields.io/badge/Twitter-1DA1F2?style=for-the-badge&logo=x&logoColor=white&labelColor=1DA1F2)](https://twitter.com/Vishalchavan_ai)
...
`React` `Tailwind` `API v4` • [![Demo](https://img.shields.io/badge/Demo-00C7B7?style=plastic&logo=vercel&logoColor=white)](https://your-demo-link.com) [![Repo](https://img.shields.io/badge/Repo-181717?style=plastic&logo=github&logoColor=white)](https://your-repo-link.com)

**🏨 WanderLodge** • Full-stack hotel booking with auth, real-time booking & Mapbox maps  
`JavaScript` `Node` `Express` `MongoDB` `Tailwind` • [![Demo](https://img.shields.io/badge/Demo-00C7B7?style=plastic&logo=vercel&logoColor=white)](https://your-demo-link.com) [![Repo](https://img.shields.io/badge/Repo-181717?style=plastic&logo=github&logoColor=white)](https://your-repo-link.com)

**♟️ Checkmate** • Online multiplayer chess with WebSockets & session recovery  
`Node` `Express` `Socket.io` `Chess.js` • [![Repo](https://img.shields.io/badge/Repo-181717?style=plastic&logo=github&logoColor=white)](https://your-repo-link.com)
...
![Framer](https://img.shields.io/badge/Framer_Motion-0055FF?style=plastic&logo=framer&logoColor=white)
![Linux](https://img.shields.io/badge/Linux-FCC624?style=plastic&logo=linux&logoColor=black)

### Foundations
![OOP](https://img.shields.io/badge/OOP-FF6B6B?style=plastic&logo=cplusplus&logoColor=white)
![Networking](https://img.shields.io/badge/Networking-4A90E2?style=plastic&logo=cisco&logoColor=white)
![OS](https://img.shields.io/badge/Operating_Systems-0078D6?style=plastic&logo=windows&logoColor=white)
![DBMS](https://img.shields.io/badge/DBMS-336791?style=plastic&logo=postgresql&logoColor=white)
![DSA](https://img.shields.io/badge/DSA_(Java)-007396?style=plastic&logo=java&logoColor=white)
...
**Delaplex Ltd.** | Jan 2025 – Jun 2025 | Nagpur, India

#### 🤖 Kaptize.ai — AI Knowledge Platform
- Shipped **40+ responsive screens** from Figma to production code with role-based dynamic components
- Integrated Razorpay payment gateway and implemented authentication with RBAC
- Built reusable Higher-Order Components (HOCs) with smooth Framer Motion animations
- **Stack:** React, JavaScript, Tailwind, Material UI, Redux, Gemini API, Framer Motion

#### 🎓 Assist.ai — AI Learning Assistant
- Built AI assistant using Gemini with speech-to-text and text-to-speech (~98% accuracy)
- Developed role-based access control with smooth animations using Framer Motion
- **Stack:** React, TypeScript, Tailwind, Redux, Web Speech APIs

---

## 🏆 Achievements & Leadership

- 🤖 **System Head** — Robotics & Aviation Club (College)
- ♟️ **Chess Champion** — 1st Place (District Level), 5th Place (State Level)
